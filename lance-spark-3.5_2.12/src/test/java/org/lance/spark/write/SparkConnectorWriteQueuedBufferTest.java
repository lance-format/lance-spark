...
/**
 * Tests the Spark write path with the queue-based QueuedArrowBatchBuffer
 * (use_queued_write_buffer=true). This tests the pipelined write approach.
 */
public class SparkConnectorWriteQueuedBufferTest {
  ...
  @Test
  public void writeWithCustomQueueDepth(TestInfo testInfo) {
    String datasetName = testInfo.getTestMethod().get().getName();
    testData
        .write()
        .format(LanceDataSource.name)
