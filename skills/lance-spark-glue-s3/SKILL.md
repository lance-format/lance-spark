...
description: Use this skill when configuring, testing, debugging, or documenting lance-spark with AWS Glue Data Catalog and S3, including Spark catalog options, pytest, CI Glue/S3 workflows, and code references for namespace-backed Lance tables.
---
...
1. Read `references/glue-s3.md` before making configuration, CI, or integration-test changes for Glue/S3.
...
- `references/glue-s3.md`: Glue/S3 setup, pytest, and CI.
