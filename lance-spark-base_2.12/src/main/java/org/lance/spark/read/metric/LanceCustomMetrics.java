 ...
 * </ul>
 *
 * <p>Future metrics gated on the {@code lance-jni} surface (not implementable in pure Java today):
 * {@code numFragmentsPruned}, {@code bytesRead}, {@code numIndexLookups}, {@code ioWaitTimeNs},
 * {@code decodeTimeNs}.
 */
