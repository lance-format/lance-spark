...
public class LanceSparkWriteOptions implements Serializable {
   ...
   * @param provider no longer used; retained for binary compatibility in callers
   * @return ReadOptions with merged storage options, session, and credential provider
   */
  public ReadOptions toReadOptions(Map<String, String> initialStorageOptions, Object provider) {
